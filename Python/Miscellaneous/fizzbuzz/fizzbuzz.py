"""
Write a program that prints the numbers from 1 to 20. But for multiples of
three print “Fizz” instead of the number and for the multiples of
five print “Buzz”. For numbers which are multiples of both three
...
"""
This just means that it will only execute when you run this program.
It will not run if imported into another program, but the previous functions
will be imported
"""
